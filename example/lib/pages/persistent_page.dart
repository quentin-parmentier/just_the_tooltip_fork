...
class TooltipPersistentExamplePage extends StatefulWidget {
  const TooltipPersistentExamplePage({Key? key}) : super(key: key);

  @override
  State<TooltipPersistentExamplePage> createState() => _DefaultPageExampleState();
}

class _DefaultPageExampleState extends State<TooltipPersistentExamplePage> {
